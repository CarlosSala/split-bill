...
import io.devexpert.splitbill.ui.util.rememberCameraState


@Composable
fun HomeScreen(
    context: Context = LocalContext.current,
    viewModel: HomeViewModel = viewModel { AppModule.provideHomeViewModel(context) },
    onTicketProcessed: () -> Unit
) {
    val uiState by viewModel.uiState.collectAsState()
    val cameraState = rememberCameraState(onImageCaptured = { viewModel.processTicket(it) })
