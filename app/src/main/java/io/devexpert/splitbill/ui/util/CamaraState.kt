package io.devexpert.splitbill.ui.util
...
fun rememberCameraState(
    ...
    // this object will be used to receive the image captured from the camera
...
class CameraState(
    ...
    // this function will be called from the UI to launch the camera
    fun launchCamera() {
